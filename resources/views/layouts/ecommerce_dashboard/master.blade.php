...
<!-- Mirrored from html.designstream.co.in/mantos/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Jan 2020 20:11:42 GMT -->
    <head>
        @include('layouts/ecommerce_dashboard/top')
    </head>
    <body>

        <div id="wrapper">
            <!-- BEGIN HEADER -->
            @include('layouts/ecommerce_dashboard/header')
            <!-- END HEADER -->
            ...
            <div class="page-container">
                ...
                <aside class="sidebar">
                    @include('layouts/ecommerce_dashboard/left_side');
                </aside>
        ...
        @include('layouts/ecommerce_dashboard/bottom')
