        <div class="page-header navbar fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="index-2.html">
                            <img src="{{ asset('admin/assets/images/logo.png') }}" alt="absolute admin" class="img-fluid logo-default"/> </a>
                    ...
                    <div class="search-bar">
                        <form class="sidebar-search  " action="http://html.designstream.co.in/mantos/light/page_general_search_3.html" method="POST">
                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                                    <img alt="" class="rounded-circle" src="{{ asset('admin/assets/images/avtar-1.jpg') }}">
